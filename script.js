...
$('#btn-start').on(isMobile ? 'touchend' : 'click', function () {
...
function createRock() {
    ...
    if (!isMobile && speed < 450) { // never let speed go below 450
        speed = 450;
    }
    else if (isMobile && speed < 200) {
        speed = 200;
    }
    ...
    if (!isMobile) {
        ...
        $(rock).animate({ bottom: 0 }, 3000, "linear", loseLife);   
    }
